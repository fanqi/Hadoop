 ...
 * 有Reducer版本
 */
public class CallList extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		Job job = new Job(conf, "CallList"); // 任务名
		job.setJarByClass(CallList.class); // 指定Class
	...
	public static void main(String[] args) throws Exception {
		...
		// 运行任务
		int res = ToolRunner.run(new Configuration(), new CallList(), args);
